...
st.title("AI powered construction site ppe detection")
uploaded_file = st.file_uploader(
    "Upload an image or video", type=["jpg", "jpeg", "png", "mp4", "avi", "mov"]
)

if uploaded_file is not None:
    model = YOLO(
        "C:/Users/vivek/VivekInternship/AI_powered_construction_site_ppe_detection/models/Yolov8n_without_aug.pt"
    )
